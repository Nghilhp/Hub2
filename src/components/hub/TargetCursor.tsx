...
export function TargetCursor({
  ...
  useEffect(() => {
    ...
    const mouseDownHandler = () => {
      if (!activeTarget || !dotRef.current) {
        return
      }

      gsap.to(dotRef.current, { duration: 0.3, scale: 0.7 })
      gsap.to(cursorRef.current, { duration: 0.2, scale: 0.9 })
    }
    ...
    const mouseUpHandler = () => {
      ...
      gsap.to(dotRef.current, { duration: 0.3, scale: 1 })
      gsap.to(cursorRef.current, { duration: 0.2, scale: 1 })
    }
